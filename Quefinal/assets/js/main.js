...
let g=+document.getElementById("Q7");
let h=+document.getElementById("Q8");
let i=+document.getElementById("Q9");
let j=+document.getElementById("Q10");
let k=4-d;
let l=4-e;
let m=4-g;
let n=4-h;
let sum=a+b+c+k+l+f+m+n+i+j;
//if(sum)*/

let t=document.getElementById("submit");
t.addEventListener('click',()=>{
  var n1=document.getElementById('Q1').value;
  var n2=document.getElementById('Q2').value;
  var n3=document.getElementById('Q3').value;
  var a=document.getElementById('Q4').value;
  var b=document.getElementById('Q5').value;
  var n4=document.getElementById('Q6').value;
  var c=document.getElementById('Q7').value;
  var d=document.getElementById('Q8').value;
  var n7=document.getElementById('Q9').value;
  var n8=document.getElementById('Q10').value;
  var n9=4-c;
  var n5=4-a;
  var n6=4-b;
